<?php
namespace Chase\Test\TestCase\Controller;
...
/**
 * Chase\Controller\PaymentController Test Case
 */
class PaymentControllerTest extends ControllerTestCase {
	...
	public function testIndexAsAnonymous() {
		...
		$this->assertPostAnonymousAccessOk(['plugin' => 'Chase', 'controller' => 'Payment', 'action' => 'index'], [
