...
<div class="credits view">
	<dl class="row">
		<dt class="col-sm-3 text-end"><?= __('Owner') ?></dt>
		<dd class="col-sm-9 mb-0"><?= $this->element('People/block', ['person' => $credit->person]) ?></dd>
		<dt class="col-sm-3 text-end"><?= __('Date') ?></dt>
		<dd class="col-sm-9 mb-0"><?= $this->Time->date($credit->created) ?></dd>
		<dt class="col-sm-3 text-end"><?= __('Initial Amount') ?></dt>
		<dd class="col-sm-9 mb-0"><?= $this->Number->currency($credit->amount) ?></dd>
		<dt class="col-sm-3 text-end"><?= __('Amount Used') ?></dt>
		<dd class="col-sm-9 mb-0"><?= $this->Number->currency($credit->amount_used) ?></dd>
<?php
if ($credit->payment_id):
?>
		<dt class="col-sm-3 text-end"><?= __('Registration') ?></dt>
...
?>
		...
		<dd class="col-sm-9 mb-0"><?= $this->Text->autoParagraph(h($credit->notes)) ?></dd>
	</dl>
</div>
