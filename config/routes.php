...
Router::scope('/', function (RouteBuilder $routes) {
	 ...
	 */
    $routes->connect('/help/*', ['controller' => 'Help', 'action' => 'view']);
	 ...
	 */
	$routes->connect('/leagues/:action/*', ['controller' => 'Leagues']);
	$routes->connect('/tournaments', ['controller' => 'Leagues', 'action' => 'index', 'tournaments' => true]);
	$routes->connect('/tournaments/:action/*', ['controller' => 'Leagues']);
