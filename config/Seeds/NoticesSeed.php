	...
	public function run() {
		$data = [
			...
			[
				...
				'display_to' => 'captain',
				'repeat_on' => NULL,
				'notice' => '<h2>Attendance tracking!</h2><p>Zuluru can do attendance tracking! Edit your team (look for the <%icon edit_24.png %> icon) to turn this popular feature on. You can also customize which emails will be sent to you and your players, and when.</p>',
				'active' => '1',
				'effective_date' => '2011-10-27 00:00:00',
				'created' => '2011-10-27 00:00:00',
			],
			...
			[
				...
				'display_to' => 'player',
				'repeat_on' => NULL,
				'notice' => '<h2>Dates and times</h2><p>You can change your preferences for how dates and times are displayed in Zuluru. Don\'t like 24 hour military-style times? Change it in <%link people preferences My Profile -> Preferences %>!</p>',
				'active' => '1',
				'effective_date' => '2011-10-27 00:00:00',
				'created' => '2011-10-27 00:00:00',
			],
			[
				...
				'display_to' => 'player',
				'repeat_on' => NULL,
				'notice' => '<h2>Online help</h2><p>Zuluru has online help. Click the <%icon help_24.png %> icon anywhere to get a popup window with help about that item.</p>',
				'active' => '1',
				'effective_date' => '2011-10-27 00:00:00',
				'created' => '2011-10-27 00:00:00',
			],
			[
				...
				'display_to' => 'player',
				'repeat_on' => NULL,
				'notice' => '<h2>Pop-up details</h2><p>When you hover your mouse over player, team, field or league names, popups appear with handy links to the most commonly requested pages, saving you valuable clicks.</p>',
				'active' => '1',
				'effective_date' => '2011-10-27 00:00:00',
				'created' => '2011-10-27 00:00:00',
			],
			[
				...
				'display_to' => 'captain',
				'repeat_on' => NULL,
				'notice' => '<h2>Ever submit the wrong score?</h2><p>If you submit an incorrect score for a game, you can correct it with the "Edit Score" link.</p>',
				'active' => '1',
				'effective_date' => '2011-10-27 00:00:00',
				'created' => '2011-10-27 00:00:00',
			],
			[
				...
				'display_to' => 'player',
				'repeat_on' => NULL,
				'notice' => '<h2>Player photos</h2><p>You can upload a photo of yourself! Captains often use photos to figure out who they want to nominate as an all-star or draft or recruit for their team. Your photo will only be visible to people who are logged in to the site.</p><p>Go to <%link people photo_upload My Profile -> Upload Photo %> to get started.</p>',
				'active' => '1',
				'effective_date' => '2011-10-27 00:00:00',
				'created' => '2011-10-27 00:00:00',
			],
