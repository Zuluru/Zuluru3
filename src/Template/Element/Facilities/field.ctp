...
<?php
if (!$new) {
	echo $this->Form->input("fields.$index.id");
}
// TODO: Add default value based on the facility's primary sport?
echo $this->Form->input("fields.$index.sport", [
...
if ($new) {
	...
	echo $this->Form->input("fields.$index.is_open", [
		'checked' => true,
		'duplicate_help' => true,
	]);
} else {
...
echo $this->Form->input("fields.$index.indoor", [
	'duplicate_help' => true,
]);
echo $this->Form->input("fields.$index.surface", [
	'options' => Configure::read('options.surface'),
	'empty' => '---',
	'hide_single' => true,
	'duplicate_help' => true,
]);
echo $this->Form->input("fields.$index.rating", [
	'options' => Configure::read('options.field_rating'),
	'empty' => '---',
	'hide_single' => true,
	'duplicate_help' => true,
]);
echo $this->Form->input("fields.$index.layout_url", [
