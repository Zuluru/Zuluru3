...
<p><?= __('This initialize process can be run any number of times, in case something happens to alter the standings after it is run the first time (e.g. a previously confirmed score is disputed).') ?></p>
