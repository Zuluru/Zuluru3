...
<h2><?= __('Administrator Guide: Player Management') ?></h2>

<h3><?= __('New Players') ?></h3>
<p><?= __('When people create accounts on your site, you will need to approve their profiles. This step is in place to avoid people creating duplicate or fraudulent accounts. (Note that this is not the case if the "Automatically approve new user accounts" feature is enabled on the {0} page.)',
	$this->Html->link(__('User Settings'), ['controller' => 'Settings', 'action' => 'user'])
) ?></p>
<p><?= __('If there are new accounts to be approved, there will be an "approve new accounts" option under the People menu. Selecting this will give you a list of the new accounts, with options to view, edit, delete or approve each. Any account detected as likely a duplicate is highlighted in this list.') ?></p>
...
<p><?= __('Apart from the "Delete silently" option, the user will always receive an email from the system informing them of the result.') ?></p>
...
<p><?= __('This is the same as deleting the user from the "new accounts" list. No notification is sent to the user, so this should not be used in the case of duplicates.') ?></p>

<h4><?= __('Delete as Duplicate') ?></h4>
<p><?= __('This option is now rarely used, as the "merge" tends to produce better results. It is retained for occasional situations where it may be preferable. This option does the same database processing as the silent deletion, but also sends an email to the addresses on both the new and old accounts reminding them of the username on the old account. It is then up to the user to remember or reset the password for that account.') ?></p>
...
<h3><?= __('Photos') ?></h3>
<p><?= __('People have the option of uploading a photo to the site. Before being made public, photos may need to be approved by an administrator, depending on the "Approve photos" setting under {0} -> {1} -> {2}.', __('Configuration'), __('Settings'), __('User')) ?></p>
<p><?= __('If there are new photos to be approved, there will be an "approve new photos" option under the People menu. Selecting this will give you a list of the new photos, with options to approve or delete each.') ?></p>
