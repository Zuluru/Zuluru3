...
<p><?= __('As of 2014, USA Ultimate is using an updated version of this algorithm for both the College and Club series, available here as "USA Ultimate Rankings v2".') ?></p>
<?php
