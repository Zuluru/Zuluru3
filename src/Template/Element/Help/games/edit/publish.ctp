...
<p><?= __('A day\'s games can be published during the creation or edit process by checking the "publish" box, or with the "publish" link from the league schedule page.') ?></p>
