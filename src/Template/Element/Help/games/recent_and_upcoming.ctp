...
<p><?= __('The "{0}" section of the {1} {2} provides a timely snapshot of the most important events on your schedule.',
	__('Recent and Upcoming Schedule'), ZULURU, __('Dashboard')
) ?></p>
<p><?= __('Recently played games will be listed, with results where known. If you are a coach or captain, you will be able to enter scores for games here, with the "Submit" link. If you\'ve entered an incorrect score, you can change it with the "{0}" button, until the game is finalized.',
	__('Edit Score')
) ?></p>
