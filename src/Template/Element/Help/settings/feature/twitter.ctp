<p><?= __('To enable Twitter integration, you must first install two support libraries into {0}.', 'zuluru/libs') ?></p>
...
<p><?= __('After this, you must set the Consumer Key and Consumer Secret values. You can obtain standard {0} values for these by contacting {1}, or you can acquire your own. If you want your own consumer values, log in to Twitter, then go to the {2}, click "Create a new application", and follow the steps.',
	ZULURU,
