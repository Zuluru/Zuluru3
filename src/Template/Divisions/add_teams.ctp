...
foreach ($colours as $key => $colour) {
	$num = $key + 1;
	echo $this->Form->input("teams.$key.name", [
		'label' => "$num.",
		'required' => false,
		'help' => false,
	]);
...
<?php
echo $this->Form->input('teams.0.open_roster', [
...
<?php
	echo $this->Form->input('teams.0.attendance_reminder', [
		'size' => 1,
		'default' => 3,
	...
	echo $this->Form->input('teams.0.attendance_summary', [
		'size' => 1,
		'default' => 1,
	...
	echo $this->Form->input('teams.0.attendance_notification', [
		'size' => 1,
		'default' => 1,
